...
| `bulk_mark_transactions_reviewed` | Clear or set the needs_review flag on many transactions at once               | `transaction_ids`, `reviewed`?, `dry_run`?                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
**Transactions**: `create_transaction`, `update_transaction`, `delete_transaction`, `categorize_transaction`, `update_transaction_notes`, `mark_transaction_reviewed`, `bulk_categorize_transactions`, `bulk_mark_transactions_reviewed`, `split_transaction`, `upload_account_balance_history`
...
`bulk_categorize_transactions`, `bulk_mark_transactions_reviewed`, `upload_account_balance_history`, `update_account` and `update_category` accept a `dry_run=True` argument that returns the planned changes without executing them, useful for previewing before approving.
